---
id: getting-started/setting-up-the-development-environment
...
Use an editor that supports JavaScript syntax highlighting, search, a terminal, and useful diagnostics. Examples include Visual Studio Code, Sublime Text, or other modern IDEs. The specific editor matters less than being able to navigate files, run commands, and understand errors.
