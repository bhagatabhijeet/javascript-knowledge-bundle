---
id: fundamentals/arithmetic-operators
...
sources:
  - resource: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators#arithmetic_operators
---
...
Unlike the other arithmetic operators, `+` also concatenates when either operand is a string. See [Dynamic typing and type coercion](./dynamic-typing.md) for the coercion rules.
